...
/* harmony import */ var _helper_classes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helper-classes */ "./src/app/services/helper-classes.ts");
...
var ChatService = /** @class */ (function () {
    function ChatService(db, alertService) {
        this.db = db;
        this.alertService = alertService;
        this.chatList = [];
        this.previousChatListLength = 0;
        this.chats = [];
        this.liveSubs = [];
    }
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, new Promise(function (res) {
                            var chatSub = _this.db.getLiveDoc('users/' + _this.db.userLink.email).subscribe(function (doc) {
                                _this.chatList = doc.payload.data()['chats'];
                                // Reload new chats only
                                for (var i = _this.previousChatListLength; i < _this.chatList.length; i++)
                                    _this.loadChat(i, _this.chatList[i]);
                                _this.previousChatListLength = _this.chatList.length;
                                res();
                            });
                            _this.liveSubs.push(chatSub);
                        })];
                    case 1:
                        // Loading user chat list
                        _a.sent();
    ...
    ChatService.prototype.loadChat = function (index, chatId) {
        var _this = this;
        var chat = new _helper_classes__WEBPACK_IMPORTED_MODULE_3__["Chat"](chatId);
        // Get entire chat from chats folder in db
        // Live for new messages
        var chatSub = this.db.getLiveDoc("chats/" + chatId).subscribe(function (doc) {
            // Chat details
            var messages = doc.payload.data()['messages'], participants = doc.payload.data()['participants'];
            // Create chat title accordingly
            if (participants.length === 2)
                chat.title = participants[0].email !== _this.db.userLink.email ? participants[0].name : participants[1].name;
            ...
            _this.chats[index] = chat;
        }, this.alertService.error);
        this.liveSubs.push(chatSub);
    };
    ChatService.prototype.createChat = function (sender, receiver, message) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        hi = new _helper_classes__WEBPACK_IMPORTED_MODULE_3__["Message"](0, message);
                        chat = new _helper_classes__WEBPACK_IMPORTED_MODULE_3__["Chat"](null, [hi], [sender, receiver], receiver.name);
                        // Create chat
                        return [4 /*yield*/, this.alertService.load('Creating Chat', new Promise(function (resolve) {
                                _this.db.createDoc('chats', JSON.parse(JSON.stringify(chat))).then(function (doc) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                // Send document id to both users
                                                chat.id = doc.id;
                                                return [4 /*yield*/, this.db.unionArray("users/" + sender.email, 'chats', chat.id)];
                                            case 1:
                                                _a.sent();
                                                return [4 /*yield*/, this.db.unionArray("users/" + receiver.email, 'chats', chat.id)];
                                            case 2:
                                                _a.sent();
                                                // Set document id to the chat
                                                return [4 /*yield*/, doc.update({
                                                        id: chat.id
                                                    })];
                                            case 3:
                                                // Set document id to the chat
                    ...
                    case 1:
                        ...
                        _a.sent();
                        // Return document id
                        return [2 /*return*/, new Promise(function (resolve) { return resolve(chat.id); })];
                }
            });
        });
    };
    ChatService.prototype.getParticipant = function (sender, index) {
    ...
    ChatService.prototype.sendMessage = function (chatId, content) {
        ...
        chat.participants.forEach(function (participant, index) {
            if (participant.email === _this.db.userLink.email)
                sender = index;
        });
        this.db.unionArray("chats/" + chatId, 'messages', Object.assign({}, new _helper_classes__WEBPACK_IMPORTED_MODULE_3__["Message"](sender, content))).catch(console.error);
    };
    ChatService.prototype.getChat = function (id) {
        var index = this.chats.findIndex(function (chat) { return chat.id === id; });
        return this.chats[index];
    };
    ChatService.prototype.isUsable = function () {
        return this.db.usable;
    };
    ChatService.prototype.ngOnDestroy = function () {
        this.liveSubs.forEach(function (sub) {
            sub.unsubscribe();
        });
    };
    Object.defineProperty(ChatService.prototype, "user", {
        get: function () {
